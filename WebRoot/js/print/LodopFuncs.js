...
**************************/
        var strHtmInstall="<br><font color='#FF00FF'>打印控件未安装!请在登陆页面 点击【下载控件32位】 下载后执行安装,安装后请刷新页面或重新进入。</font>";
        var strHtmUpdate="<br><font color='#FF00FF'>打印控件需要升级!请在登陆页面 点击【下载控件32位】 下载后执行安装,升级后请刷新页面或重新进入。</font>";
        var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!请在登陆页面 点击【下载控件64位】 下载后执行安装,安装后请刷新页面或重新进入。</font>";
        var strHtm64_Update="<br><font color='#FF00FF'>打印控件需要升级!请在登陆页面 点击【下载控件64位】 下载后执行安装,升级后请刷新页面或重新进入。</font>";
